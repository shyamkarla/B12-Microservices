package com.b12.inventory.inventoryService;
...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("inventory-api")
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Inventory Service API")
