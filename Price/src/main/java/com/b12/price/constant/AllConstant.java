package com.b12.price.constant;
...
public class AllConstant {
	...
	public static final String INVALID_PRICE_ID = "Price ID not received / Invalid";
	public static final String PRICE_ID_NOT_FOUND = "Price ID not found in DB";
